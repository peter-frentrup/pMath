...
#  if defined(PMATH_64BIT)
    ...
    static_assert(sizeof(ContainerWidgetBox)        == 104, ""); // (64 + 8) + 8 + 12+4 + 2*1 + 2 + 4 UNUSED PADDING BYTES
    static_assert(sizeof(AbstractButtonBox)         == 104, "");
    static_assert(sizeof(ButtonBox)                 == 104, "");
    static_assert(sizeof(SetterBox)                 == 136, ""); // (104) + 24 + 8
    static_assert(sizeof(InputFieldBox)             == 144, ""); // (104) + 8 + 8 + 24
...
#  elif defined(PMATH_32BIT)
    ...
    static_assert(sizeof(ContainerWidgetBox)        ==  76, ""); // (48 + 4) + 4 + 12+4 + 2*1 + 2
    static_assert(sizeof(AbstractButtonBox)         ==  76, "");
    static_assert(sizeof(ButtonBox)                 ==  76, "");
    static_assert(sizeof(SetterBox)                 == 104, ""); // (76) + 4 UNUSED PADDING BYTES + 16 + 8
    static_assert(sizeof(InputFieldBox)             == 104, ""); // (76) + 4 + 8 + 16
    ...
    static_assert(sizeof(PanelBox)                  ==  76, "");
