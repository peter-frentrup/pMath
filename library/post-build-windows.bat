...
COPY /Y bin\windows\%1\*.dll        test\bin\windows\%1\*
COPY /Y bin\windows\%1\*.pdb        test\bin\windows\%1\*
...
COPY /Y bin\windows\%1\*.dll        console\bin\windows\%1\*
COPY /Y bin\windows\%1\*.pdb        console\bin\windows\%1\*
