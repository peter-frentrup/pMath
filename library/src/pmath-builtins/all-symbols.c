...
PMATH_PRIVATE pmath_bool_t _pmath_symbol_builtins_init(void){
  ...
  VERIFY(   PMATH_SYMBOL_ACCURACY                  = NEW_SYSTEM_SYMBOL("Accuracy"))
  ...
  VERIFY(   PMATH_SYMBOL_INPUTBOX                  = NEW_SYSTEM_SYMBOL("InputBox"))
...
//    BIND_UP(     PMATH_SYMBOL_TAN,                         builtin_power_tan)
  ...
  SET_ATTRIB( PMATH_SYMBOL_RULEDELAYED,                   HOLDREST);
