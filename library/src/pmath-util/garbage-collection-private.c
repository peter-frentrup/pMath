...
static pmath_bool_t gc_visit_limbo_dispatch_table(_pmath_dispatch_table_expr_t *table, void *dummy);
...
static pmath_bool_t gc_dispatch_table_has_only_alive_symbols(_pmath_dispatch_table_expr_t *table, void *dummy); 
