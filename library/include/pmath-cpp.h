...
namespace pmath {
  ...
  inline Expr Imaginary(Expr &&im)             { return Complex(0, std::forward<Expr>(im)); }
  ...
  inline Expr List(Expr &&x1) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1));
  }
  inline Expr List(Expr &&x1, Expr &&x2) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4, Expr &&x5) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4), std::forward<Expr>(x5));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4, Expr &&x5, Expr &&x6) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4), std::forward<Expr>(x5), std::forward<Expr>(x6));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4, Expr &&x5, Expr &&x6, Expr &&x7) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4), std::forward<Expr>(x5), std::forward<Expr>(x6), std::forward<Expr>(x7));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4, Expr &&x5, Expr &&x6, Expr &&x7, Expr &&x8) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4), std::forward<Expr>(x5), std::forward<Expr>(x6), std::forward<Expr>(x7), std::forward<Expr>(x8));
  }
  inline Expr List(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4, Expr &&x5, Expr &&x6, Expr &&x7, Expr &&x8, Expr &&x9) {
    return Call(Symbol(PMATH_SYMBOL_LIST), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4), std::forward<Expr>(x5), std::forward<Expr>(x6), std::forward<Expr>(x7), std::forward<Expr>(x8), std::forward<Expr>(x9));
  }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Rule(       Expr &&l, Expr &&r) { return Call(Symbol(PMATH_SYMBOL_RULE),        std::forward<Expr>(l), std::forward<Expr>(r)); }
  inline Expr RuleDelayed(Expr &&l, Expr &&r) { return Call(Symbol(PMATH_SYMBOL_RULEDELAYED), std::forward<Expr>(l), std::forward<Expr>(r)); }
#endif
  
  inline Expr Power(const Expr &x, const Expr &y) { return Call(Symbol(PMATH_SYMBOL_POWER), x, y); }
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Power(Expr &&x, Expr &&y) { return Call(Symbol(PMATH_SYMBOL_POWER), std::forward<Expr>(x), std::forward<Expr>(y)); }
#endif
  
  inline Expr Sqrt(const Expr &x) { return Power(x, Rational(1, 2)); }
  inline Expr Inv(const Expr &x) {  return Power(x, -1); }
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Sqrt(Expr &&x) { return Power(std::forward<Expr>(x), Rational(1, 2)); }
  inline Expr Inv(Expr &&x) {  return Power(std::forward<Expr>(x), -1); }
#endif
  
  inline Expr Exp(const Expr &x) { return Power(Symbol(PMATH_SYMBOL_E), x); }
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Exp(Expr &&x) { return Power(Symbol(PMATH_SYMBOL_E), std::forward<Expr>(x)); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Log(Expr &&x) {           return Call(Symbol(PMATH_SYMBOL_LOG), std::forward<Expr>(x)); }
  inline Expr Log(Expr &&b, Expr &&x) { return Call(Symbol(PMATH_SYMBOL_LOG), std::forward<Expr>(b), std::forward<Expr>(x)); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Sin(   Expr &&x) { return Call(Symbol(PMATH_SYMBOL_SIN), std::forward<Expr>(x)); }
  inline Expr Cos(   Expr &&x) { return Call(Symbol(PMATH_SYMBOL_COS), std::forward<Expr>(x)); }
  inline Expr Tan(   Expr &&x) { return Call(Symbol(PMATH_SYMBOL_TAN), std::forward<Expr>(x)); }
  inline Expr ArcSin(Expr &&x) { return Call(Symbol(PMATH_SYMBOL_ARCSIN), std::forward<Expr>(x)); }
  inline Expr ArcCos(Expr &&x) { return Call(Symbol(PMATH_SYMBOL_ARCCOS), std::forward<Expr>(x)); }
  inline Expr ArcTan(Expr &&x) { return Call(Symbol(PMATH_SYMBOL_ARCTAN), std::forward<Expr>(x)); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Times(Expr &&x1, Expr &&x2) {                       return Call(Symbol(PMATH_SYMBOL_TIMES), std::forward<Expr>(x1), std::forward<Expr>(x2)); }
  inline Expr Times(Expr &&x1, Expr &&x2, Expr &&x3) {            return Call(Symbol(PMATH_SYMBOL_TIMES), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3)); }
  inline Expr Times(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4) { return Call(Symbol(PMATH_SYMBOL_TIMES), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4)); }
#endif
  
  inline Expr Divide(const Expr &x, const Expr &y) { return Times(x, Inv(y)); }
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Divide(Expr &&x, Expr &&y) { return Times(std::forward<Expr>(x), Inv(std::forward<Expr>(y))); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Plus(Expr &&x1, Expr &&x2) {                       return Call(Symbol(PMATH_SYMBOL_PLUS), std::forward<Expr>(x1), std::forward<Expr>(x2)); }
  inline Expr Plus(Expr &&x1, Expr &&x2, Expr &&x3) {            return Call(Symbol(PMATH_SYMBOL_PLUS), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3)); }
  inline Expr Plus(Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4) { return Call(Symbol(PMATH_SYMBOL_PLUS), std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4)); }
#endif
  
  inline Expr Minus(const Expr &x) {                return Times(-1, x); }
  inline Expr Minus(const Expr &x, const Expr &y) { return Plus(x, Minus(y)); }
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Minus(Expr &&x) {           return Times(-1, std::forward<Expr>(x)); }
  inline Expr Minus(Expr &&x, Expr &&y) { return Plus(std::forward<Expr>(x), Minus(std::forward<Expr>(y))); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Abs( Expr &&x) { return Call(Symbol(PMATH_SYMBOL_ABS),  std::forward<Expr>(x)); }
  inline Expr Arg( Expr &&x) { return Call(Symbol(PMATH_SYMBOL_ARG),  std::forward<Expr>(x)); }
  inline Expr Sign(Expr &&x) { return Call(Symbol(PMATH_SYMBOL_SIGN), std::forward<Expr>(x)); }
  inline Expr Re(  Expr &&x) { return Call(Symbol(PMATH_SYMBOL_RE),   std::forward<Expr>(x)); }
  inline Expr Im(  Expr &&x) { return Call(Symbol(PMATH_SYMBOL_IM),   std::forward<Expr>(x)); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Ceiling(Expr &&x) {           return Call(Symbol(PMATH_SYMBOL_CEILING), std::forward<Expr>(x)); }
  inline Expr Ceiling(Expr &&x, Expr &&a) { return Call(Symbol(PMATH_SYMBOL_CEILING), std::forward<Expr>(x), std::forward<Expr>(a)); }
  inline Expr Floor(  Expr &&x) {           return Call(Symbol(PMATH_SYMBOL_FLOOR),   std::forward<Expr>(x)); }
  inline Expr Floor(  Expr &&x, Expr &&a) { return Call(Symbol(PMATH_SYMBOL_FLOOR),   std::forward<Expr>(x), std::forward<Expr>(a)); }
  inline Expr Round(  Expr &&x) {           return Call(Symbol(PMATH_SYMBOL_ROUND),   std::forward<Expr>(x)); }
  inline Expr Round(  Expr &&x, Expr &&a) { return Call(Symbol(PMATH_SYMBOL_ROUND),   std::forward<Expr>(x), std::forward<Expr>(a)); }
#endif
...
#ifdef PMATH_CPP_USE_RVALUE_REF
  inline Expr Quotient(Expr &&m, Expr &&n) {           return Call(Symbol(PMATH_SYMBOL_QUOTIENT), std::forward<Expr>(m), std::forward<Expr>(n)); }
  inline Expr Quotient(Expr &&m, Expr &&n, Expr &&d) { return Call(Symbol(PMATH_SYMBOL_QUOTIENT), std::forward<Expr>(m), std::forward<Expr>(n), std::forward<Expr>(d)); }
  inline Expr Mod(     Expr &&m, Expr &&n) {           return Call(Symbol(PMATH_SYMBOL_MOD),      std::forward<Expr>(m), std::forward<Expr>(n)); }
  inline Expr Mod(     Expr &&m, Expr &&n, Expr &&d) { return Call(Symbol(PMATH_SYMBOL_MOD),      std::forward<Expr>(m), std::forward<Expr>(n), std::forward<Expr>(d)); }
#endif
  ...
  inline Expr Parse(const char *code, Expr &&x1) {
    return ParseArgs(code, List(std::forward<Expr>(x1)));
  }
  inline Expr Parse(const char *code, Expr &&x1, Expr &&x2) {
    return ParseArgs(code, List(std::forward<Expr>(x1), std::forward<Expr>(x2)));
  }
  inline Expr Parse(const char *code, Expr &&x1, Expr &&x2, Expr &&x3) {
    return ParseArgs(code, List(std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3)));
  }
  inline Expr Parse(const char *code, Expr &&x1, Expr &&x2, Expr &&x3, Expr &&x4) {
    return ParseArgs(code, List(std::forward<Expr>(x1), std::forward<Expr>(x2), std::forward<Expr>(x3), std::forward<Expr>(x4)));
  }
#endif
