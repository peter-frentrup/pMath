...
enum {
  ...
  /** Any pmath_expr_t.
   */
  PMATH_TYPE_EXPRESSION              = PMATH_TYPE_EXPRESSION_GENERAL | PMATH_TYPE_EXPRESSION_GENERAL_PART | PMATH_TYPE_PACKED_ARRAY | PMATH_TYPE_CUSTOM_EXPRESSION,
...
struct pmath_write_ex_t {
  ...
  /**\brief Write callback.
     ...
     This is mandatory.
   */
  void (*write)(void *user, const uint16_t *str, int len);
