#ifndef PMATH_UTIL__CONCURRENCY__ATOMIC_PRIVATE_H__INCLUDED
#define PMATH_UTIL__CONCURRENCY__ATOMIC_PRIVATE_H__INCLUDED
...
#endif /* PMATH_UTIL__CONCURRENCY__ATOMIC_PRIVATE_H__INCLUDED */
